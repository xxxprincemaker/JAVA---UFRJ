...
public class TuiterLiteTest {
    ...
    public void testeAutorDoTuite() {
        ...
        } catch (TamanhoMaximoTuitesException e) {
            e.printStackTrace();
    ...
    public void testeTuiteDeUsuarioDesconhecido() {
        try {
            ...
            System.out.println("Erro: Voce atingiu o limite máximo de Tuites.");
        }

    }

    @Test
    public void testeTamanhoTuite() throws UsuarioInexistenteException {
        try {
        ...
        try {
            ...
            fail("Uma excessao deve ser lancada quando o numero de caracteres for maior que o permitido!");
        } catch (TamanhoMaximoTuitesException e){
            System.out.println("Erro: Seu tuite é maior que o tamanho permitido.");
        }
    }
...
//        tuite.anexarAlgo(new Object());  // essa linha, se fosse descomentada, daria erro de compilação
    ...
    public void testePerformanceTuites() {
        ...
        try {
            ...
            fail("Uma excessao deve ser lancada, quando o usuario nao cadastrado tenta tuitar algo.");
        } catch (UsuarioInexistenteException e){
            System.out.println("Erro: Usuario Inexistente.");
        } catch (TamanhoMaximoTuitesException e){
            System.out.println("Erro: Tamanho Máximo de Tuites.");
        }
