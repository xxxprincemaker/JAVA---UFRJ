...
public class TuiterLite<T> {
     ...
     */
    public Tuite tuitarAlgo(Usuario usuario, String texto) throws TamanhoMaximoTuitesException, UsuarioInexistenteException {

        if (texto.length() > TAMANHO_MAXIMO_TUITES) {
            throw new TamanhoMaximoTuitesException();  // ToDo lançar uma exceção
        }
